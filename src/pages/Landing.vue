  ...
  <div>
    <div class="page-header page-header-small">
      <parallax
        ...
        style="background-image: url('img/newEraField.jpg')"
      >
      </parallax>
          ...
          <div class="row">
            <div class="col-md-6">
              <div
                ...
                style="background-image: url('img/giApartments.jpg')"
              >
                <!-- First image on the left side -->
                <p class="blockquote blockquote-primary">
                  "Above and beyond quality video and still shots.  The staff was professional, prompt and a pleasure to deal with.  Brought our marketing to the next level."
                  <br />
                  <br />
                  <small>-DMP</small>
                </p>
            ...
            <div class="col-md-5">
              ...
              <table>
                <tr class="theader">
                  <th></th>
                  <th>Up to 3,000 Sq Ft</th>
                  <th>Over 3,000 Sq Ft</th>
                </tr>
                <tr>
                  <td>Aerial - up to 15 photos</td>
                  <td>$275+</td>
                  <td>$275+</td>
                </tr>
                <tr class="theader">
                ...
                <tr>
                  <td>Ground Ext. - up to 5 photos</td>
                  <td>$100+</td>
                  <td>$200+</td>
                </tr>
                <tr>
                  <td>Ground Int. - up to 10 photos</td>
                  <td>$150+</td>
                  <td>$250+</td>
                </tr>
                <tr>
                  <td>Complete Photo Package</td>
                  <td>$450+</td>
                  <td>$750+</td>
                </tr>
               <tr class="theader">
                  <td>Add On Video Services</td>
                  <td></td>
                  <td></td>
                </tr>                  
                <tr>
                  <td>Aerial - up to 3 minute video</td>
                  <td>$300+</td>
                  <td>$400+</td>
                </tr>
                <tr>
                  <td>Ground - up to 3 minute video</td>
                  <td>$200+</td>
                  <td>$300+</td>
                </tr>
                <tr>
                  <td>Photo & Video Package</td>
                  <td>$850+</td>
                  <td>$1,350+</td>
                </tr>
                <tr>
                  <td>Panoramic Photo Add On</td>
                  <td>$100+</td>
                  <td>$100+</td>
                </tr>                                
              </table> -->
